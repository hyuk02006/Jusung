...
BOOL CListCtrlDemoDlg::OnInitDialog()
{
	...
	//////////////////////////////////////
	m_ctrlFriend.InsertItem(0, _T("송기혁"));
	...
	m_ctrlFriend.InsertItem(1, _T("유재석"));
	...
	m_ctrlFriend.InsertItem(2,_T("박명수"));
	...
	m_ctrlFriend.InsertItem(3, _T("하하"));
	...
	m_ctrlFriend.InsertItem(4, _T("정준하"));
