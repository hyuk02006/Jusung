...
print(date[0:4], '년', date[6], '월', date[8:10], '일',
      date[13:15], '시', date[19], '분')


# -----------------------------------------
#  (4-1) 문자열 관련 함수
#       s.count('글') : s 문자열에서 '글'이라는 문자 개수 세기
#       s.index('글') : s 문자열에서 문자 '글' 위치 알려주기   에러반환
#       s.find('글') : s 문자열에서 문자 '글' 위치 알려주기 -1반환
...
print(msg.startswith('우리'))   # '우리'라는 문자로 시작하는가
print('45'.zfill(4))  # zero로 fill 채운다. 즉 4자리에서 남는 자리수는 0으로 채운다
